    ...
    <div>
      ...
      <div className="flex justify-center mobile:flex-col mobile:mt-3 mobile:p-3">
        ...
        <div className="flex-[1.3] flex items-start justify-items-start flex-col mt-10 mobile:items-center">
          <h1 className="title text-[40px] mobile:text-[30px]">Black hoody Original</h1>
          <p className="pr-[4rem] text-justify mt-4 mobile:pr-0">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel
            explicabo doloribus voluptate doloremque temporibus, obcaecati qui
            quae laborum maiores id perspiciatis porro nesciunt debitis, quis
            ut! Molestiae voluptates unde nam?
          </p>
